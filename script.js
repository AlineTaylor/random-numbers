...
// TODO generate function to generate numbers according to each level
const level = {
  easy: 5,
  medium: 10,
  hard: 100,
...
function generateNumber(nivel) {
  let displayNumber = Math.random() * nivel;
  console.log(Math.floor(displayNumber));
}

generateNumber(level.medium);
